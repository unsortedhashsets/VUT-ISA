...
test:
	...
	snmpget localhost .1.3.6.1.3.22.1.0 || true
	snmpget localhost .1.3.6.1.3.22.2.0 || true
	snmpget localhost .1.3.6.1.3.22.3.0 || true
	snmpget localhost .1.3.6.1.3.22.4.0 || true
